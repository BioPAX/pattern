...
Source code of the Pattern search project 
was moved to [Paxtools](https://github.com/BioPAX/Paxtools.git), 
...
This software is developed as a library, however it also supports searching BioPAX models using some pre-defined patterns and output formats, without any programming. 
To do this, run the biopax-pattern jar (from the BioPAX Maven repository or downloads) with the following command.
